...
namespace emlakAPI.Controllers
{
    ...
    {
        DBfinalEntities db = new DBfinalEntities();
        ...
        public SonucModel KategoriSil(int katId)
        {
            ...
            {
                sonuc.islem = false;
                sonuc.mesaj = "Üzerinde İlan Kayıtlı Kategori Silinemez!";
                return sonuc;
            }
        ...
        {
            List<IlanModel> liste = db.Ilan.OrderByDescending(o => o.IlanId).Take(s).Select(x => new IlanModel()
            {
                IlanId = x.IlanId,
                Baslik = x.Baslik,
                Icerik = x.Icerik,
        ...
        {
            List<IlanModel> liste = db.Ilan.Where(s => s.KategoriId == katId).Select(x => new IlanModel()
            {
                IlanId = x.IlanId,
                Baslik = x.Baslik,
                Icerik = x.Icerik,
        ...
        {
            List<IlanModel> liste = db.Ilan.Where(s => s.UyeId == uyeId).Select(x => new IlanModel()
            {
                IlanId = x.IlanId,
                Baslik = x.Baslik,
                Icerik = x.Icerik,
        ...
        public SonucModel IlanSil(int ilanId)
        {
            ...
            {
                sonuc.islem = false;
                sonuc.mesaj = "Üzerinde Yorum Kayıtlı İlan Silinemez!";
                return sonuc;
            }
        ...
        {
            List<YorumModel> liste = db.Yorum.Where(s => s.IlanId == ilanId).Select(x => new YorumModel()
            {
                YorumId = x.YorumId,
                YorumIcerik = x.YorumIcerik,
                IlanId = x.IlanId,
